...
public class SwiftDeviceCalendarPlugin: NSObject, FlutterPlugin, EKEventViewDelegate, UINavigationControllerDelegate {
    ...
    let unauthorizedErrorMessage = "The user has not allowed this application to modify their calendar(s) - JP TEST"
    ...
    private func hasEventPermissions() -> Bool {
        ...
        if #available(iOS 17, *) {
            return status == EKAuthorizationStatus.writeOnly
        } else {
